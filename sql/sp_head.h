...
public:
  ...
  */
  ...
  sp_head(sp_package *m_parent, const Sp_handler *handler);
...
public:
  ...
  */
  ...
  virtual bool add_routine_declaration(THD *thd, LEX *lex)
  {
    DBUG_ASSERT(0);
    return true;
  }

  virtual bool add_routine_implementation(THD *thd, LEX *lex)
  {
    DBUG_ASSERT(0);
    return true;
  }
...
public:
  ...
  ~sp_package() { cleanup(); }
  bool add_routine_declaration(THD *thd, LEX *lex);
  bool add_routine_implementation(THD *thd, LEX *lex);
