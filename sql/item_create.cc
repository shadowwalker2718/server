                               ...
                               bool use_explicit_name, List<Item> *item_list)
{
  ...
  if (sp_handler_function.sp_resolve_package_routine(thd, thd->lex->sphead,
                                                     qname,
                                                     &pkgname))
    return NULL;
  if (sp_handler_function.add_used_routine(lex, thd, qname))
    return NULL;
  if (pkgname.m_db.length && pkgname.m_name.length &&
